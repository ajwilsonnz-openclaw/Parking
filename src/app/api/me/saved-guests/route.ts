...
export async function POST(req: NextRequest) {
  ...
  try {
    await execDb('INSERT INTO saved_guests (id, user_id, name, phone, plate, make_model_color) VALUES (?,?,?,?,?,?)', [
